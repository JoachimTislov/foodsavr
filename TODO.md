...
actions:
- [x] move edit and delete icons (allow sigout and setting to always be present)
- [x] omit icons for product category and consider omiting maping of product to catories
- [x] 0d -> Today
- [x] <0d -> Expired
