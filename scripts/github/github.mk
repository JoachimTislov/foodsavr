...
gh-resolve-active:
	...
	@bash scripts/github/resolve_active_review_threads.sh

gh-resolve-outdated:
	@echo "Resolving outdated PR review threads..."
	@bash scripts/github/resolve_outdated_review_threads.sh
...
gh-resolve-thread:
	...
	@bash scripts/github/resolve_thread_by_id.sh "$(id)"

gh-get-active-comment:
	@bash scripts/github/get_active_comment.sh $(filter-out $@,$(MAKECMDGOALS))

gh-sync-pr:
	@bash scripts/github/sync_pr_with_base.sh
