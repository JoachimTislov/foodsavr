...
3.  **Run the application:**
    ...
    **Recommended (Using Make):**
    The easiest way to run the app is using the provided `Makefile`, which automatically handles flavors, environment variables, and starts the Firebase emulators if they aren't already running.
    ```bash
